...
In scope:
- Stillness, Reception, The Mirror assessment
- Distortion detection for SYLA signatures
- RED TEAM / BLUE TEAM evaluation
- Axis partner handoff to KHEM

Out of scope:
- Other gate assessments (each gate has its own agent)
- Canon promotion
- Direct user communication

Read root: `/root/MW_CENTRAL/TRIANGULUM/HELIOS/NYX/ENTROPY_MODEL/`
Write root: own agent-space only
