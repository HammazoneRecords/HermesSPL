...
// Jamaica RBG theme pack — Rastafarian / Pan-African palette
import { jamaicaRbgDark, jamaicaRbgLight } from './jamaica-rbg'
...
export const BUILTIN_THEMES: Record<string, DesktopTheme> = {
  ...
  jamaica: jamaicaRbgDark,
  'jamaica-light': jamaicaRbgLight
}
