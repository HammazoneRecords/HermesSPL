...
import { $cronActivityUnreadCount, markCronActivityViewed } from '@/store/cron-activity'
...
export function ChatSidebar({
  ...
  const cronActivityUnreadCount = useStore($cronActivityUnreadCount)
              ...
              {[...SIDEBAR_NAV, ...contributedNav].map(item => {
                ...
                const button = (
                  ...
                  >
                    ...
                    {item.id === 'cron' && cronActivityUnreadCount > 0 && (
                      <span className="ml-auto inline-flex size-5 shrink-0 items-center justify-center rounded-full bg-primary text-[0.6rem] font-bold text-primary-foreground">
                        {cronActivityUnreadCount > 99 ? '99+' : cronActivityUnreadCount}
                      </span>
                    )}
                    {isNewSession && (
                      <KbdGroup
